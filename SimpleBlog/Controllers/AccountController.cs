    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult UnlockUser(string userId)
        {
            ...
            try
            {
                ...
                UserManager.SetLockoutEndDate(userId, DateTimeOffset.MinValue);
                return Redirect(Request.UrlReferrer.ToString());
            }
            catch (Exception e)
            {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult> ChangeRole(string userId, string roleName)
        {
            try
            {
                var rolesOfUser = await UserManager.GetRolesAsync(userId);
                await UserManager.RemoveFromRolesAsync(userId, rolesOfUser.ToArray());
